...
class OllamaControlPanel:
    ...
    def setup_gui(self):
        ...
        # Set main window as primary and configure viewport for horizontal layout
        dpg.create_viewport(title="Ollama Control Panel", width=1400, height=750, min_width=1200, min_height=600)
        dpg.setup_dearpygui()
        dpg.show_viewport()
