...
+- For no_memories_found: ONLY use this status if:
   * Message is pure gibberish or noise with no extractable meaning
   * Message contains zero meaningful information (e.g., "ok", "yes", "lol")
   * Otherwise, ALWAYS extract and return "success" status
